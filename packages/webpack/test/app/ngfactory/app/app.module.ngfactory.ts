...
import * as import14 from '@angular/core/src/linker/ng_module_factory_loader';
...
class AppModuleInjector extends import0.NgModuleInjector<import1.AppModule> {
  ...
  _AppModule_2:import1.AppModule;
  ...
  get _Router_10():any {
    if ((this.__Router_10 == (null as any))) { (this.__Router_10 = import2.setupRouter(this.parent.get(import12.ApplicationRef),this._UrlSerializer_6,this._RouterOutletMap_7,this._Location_5,this,this._NgModuleFactoryLoader_8,this.parent.get(import11.Compiler),this._ROUTES_9,this._ROUTER_CONFIGURATION_3)); }
  ...
  createInternal():import1.AppModule {
    this._ROUTER_FORROOT_GUARD_0 = import2.provideForRootGuard(this.parent.get(import13.Router,(null as any)));
    this._RouterModule_1 = new import2.RouterModule(this._ROUTER_FORROOT_GUARD_0);
    this._AppModule_2 = new import1.AppModule();
    return this._AppModule_2;
  }
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import1.AppModule)) { return this._AppModule_2; }
    ...
    if ((token === import14.NgModuleFactoryLoader)) { return this._NgModuleFactoryLoader_8; }
    if ((token === import15.ROUTES)) { return this._ROUTES_9; }
    if ((token === import13.Router)) { return this._Router_10; }
    if ((token === import16.ActivatedRoute)) { return this._ActivatedRoute_11; }
    if ((token === import17.APP_BOOTSTRAP_LISTENER)) { return this._APP_BOOTSTRAP_LISTENER_12; }
    if ((token === import18.LOCALE_ID)) { return this._LOCALE_ID_13; }
    if ((token === import18.TRANSLATIONS_FORMAT)) { return this._TRANSLATIONS_FORMAT_14; }
